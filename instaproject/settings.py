...
SECRET_KEY = 'django-insecure-*$&-m)^j5=59e2yucy29g-8rm(l6s8up8c1j&q$7lljg3#w!r!'
...
DATABASES = {
    'default': {
        ...
        'USER': 'lissawarshaw',
        'PASSWORD': 'lissaw',
        'HOST': 'localhost',  # or another hostname if your database is on another server
        'PORT': '5432',  # leave empty if you use the default postgres port
    }
}
